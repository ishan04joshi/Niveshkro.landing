...
export default function Header() {
  ...
  const MobileNavContent = (
    ...
    >
      ...
      />
      <Button w="full" variant="ghost" onClick={() => navigate("/funds")}>
        Funds
      </Button>
      <Button w="full" variant="ghost" onClick={() => navigate("/news")}>
        News
      </Button>
      <Button w="full" variant="ghost" onClick={() => navigate("/about")}>
        About
      </Button>
      <Button w="full" variant="ghost" onClick={() => navigate("/contact")}>
        Contact
      </Button>
    </VStack>
  );
